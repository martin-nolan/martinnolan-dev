          ...
          <Reveal key={item.id} delayMs={index * 110}>
            <article className="rounded-[1.6rem] border border-[color:var(--border-soft)] bg-[color:var(--paper)] p-6 shadow-[0_18px_48px_rgba(78,65,52,0.055)]">
              <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
                <div>
                  <span className="inline-flex rounded-full border border-[color:rgba(11,122,132,0.2)] bg-[color:rgba(11,122,132,0.08)] px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-[color:var(--accent-teal)]">
                    {item.label}
                  </span>
