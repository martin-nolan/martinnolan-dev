      ...
      <div className="grid gap-5 p-5 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="space-y-5">
          <div className="rounded-[1.6rem] border border-[color:rgba(255,255,255,0.07)] bg-[color:rgba(255,255,255,0.03)] p-4">
            ...
            <div className="mt-5 border-t border-[color:rgba(255,255,255,0.06)] pt-5">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3 md:hidden">
            {runRows.map((row) => (
              <div
                key={`${row.scenario}-${row.behaviour}-mobile`}
                className="rounded-[1.3rem] border border-[color:rgba(255,255,255,0.07)] bg-[color:rgba(255,255,255,0.03)] p-3"
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <p className="truncate text-sm font-medium text-white">{row.scenario}</p>
                    <p className="mt-0.5 truncate text-xs text-[color:rgba(227,239,239,0.6)]">{row.behaviour}</p>
                  </div>
                  <span
                    className={`inline-flex shrink-0 rounded-full px-1.5 py-0.5 text-[0.6rem] font-semibold uppercase tracking-[0.08em] ${
                ...
                <div className="mt-2 flex gap-3 text-[0.68rem] text-[color:rgba(227,239,239,0.5)]">
